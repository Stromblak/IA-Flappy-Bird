...
try:
    with open("./sarsaqlearning/ss.json", "r") as file:
...
def saveqvalues():
    ...
    with open("./sarsaqlearning/ss.json", "w") as file:
...
def savescr(score):
    try:
        with open("./sarsaqlearning/scoress.txt", "a") as file:
            file.write(f"{score}\n")
    except FileNotFoundError:
        with open("./sarsaqlearning/scoress.txt", "w") as file:
            file.write(f"{score}\n")
